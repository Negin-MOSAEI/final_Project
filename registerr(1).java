...
class register extends JFrame implements ActionListener {
    ...
    public void readb(String name,String pass,String phone,String email,Boolean admincheck){
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==login){
            ...
            if(checkUser(user_name.getText())){
                ...
                readb(user_name.getText(),pass.getText(),phone.getText(),email.getText(),admincheck);
            }
        }
    }
}